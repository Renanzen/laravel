    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="card">
            <img src="https://placehold.co/600x400" class="card-img-top" alt="Animal 1">
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            <img src="https://placehold.co/600x400" class="card-img-top" alt="Animal 2">
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            <img src="https://placehold.co/600x400" class="card-img-top" alt="Animal 3">
            <div class="card-body">
